...
export default function SeriesCard({ series }: SeriesCardProps) {
  ...
  return (
    <div className="relative group overflow-hidden flex flex-col w-80 flex-shrink-0">
      <Link
        href={`/details/series/${show.id}`}
        className="flex  h-full w-80 bg-gray-900 rounded-xl shadow-lg border border-indigo-500/20 hover:border-indigo-500/60 transition-all duration-300 cursor-pointer flex-shrink-0"
      >
        {/* Poster */}
